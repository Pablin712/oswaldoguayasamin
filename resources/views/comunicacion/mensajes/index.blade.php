        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                            ...
                            <p class="mt-1">La interfaz de usuario tipo bandeja de correo está pendiente de desarrollo.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">Módulo: Sistema de Mensajería</h3>

                    <div class="space-y-3">
                        <p><strong>Estado del Backend:</strong> ✅ Completado</p>
                        <p><strong>Controlador:</strong> MensajeController</p>

                        <div class="mt-6">
                            <h4 class="font-semibold mb-2">Funcionalidades implementadas en el backend:</h4>
                            <ul class="list-disc list-inside space-y-1 text-sm">
                                <li>Sistema de mensajería interna tipo email</li>
                                <li>Mensajes individuales y masivos</li>
                                <li>Anuncios generales</li>
                                <li>Archivos adjuntos</li>
                                <li>Marcar como leído/no leído</li>
                                <li>Contador de mensajes no leídos</li>
                                <li>Filtros por tipo (recibidos/enviados/anuncios)</li>
                            </ul>
                        </div>

                        <div class="mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            <p class="text-sm"><strong>Datos cargados:</strong></p>
                            <p class="text-sm">Mensajes: {{ isset($mensajes) ? $mensajes->total() : 0 }}</p>
                            <p class="text-sm">Tipo actual: {{ isset($tipo) ? ucfirst($tipo) : 'Todos' }}</p>
                        </div>
                    </div>
                </div>
            </div>
