        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">Módulo: Sistema de Notificaciones</h3>

                    <div class="space-y-3">
                        <p><strong>Estado del Backend:</strong> ✅ Completado</p>
                        <p><strong>Controlador:</strong> NotificacionController</p>

                        <div class="mt-6">
                            <h4 class="font-semibold mb-2">Funcionalidades implementadas en el backend:</h4>
                            <ul class="list-disc list-inside space-y-1 text-sm">
                                <li>Sistema de notificaciones push</li>
                                <li>Envío de notificaciones por email</li>
                                <li>Tipos: info, warning, success, error</li>
                                <li>Marcar como leída/no leída</li>
                                <li>Marcar todas como leídas</li>
                                <li>Eliminar notificaciones leídas</li>
                                <li>Contador de no leídas para badge</li>
                                <li>Últimas notificaciones</li>
                            </ul>
                        </div>

                        <div class="mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            <p class="text-sm"><strong>Datos cargados:</strong></p>
                            <p class="text-sm">Notificaciones: {{ isset($notificaciones) ? $notificaciones->total() : 0 }}</p>
                            <p class="text-sm">No leídas: {{ isset($noLeidas) ? $noLeidas : 0 }}</p>
                        </div>
                    </div>
                </div>
            </div>
