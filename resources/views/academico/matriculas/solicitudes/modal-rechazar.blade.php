...
<x-modal name="rechazar-solicitud" maxWidth="md" focusable>
    <div class="p-6">
        <div class="text-center mb-6">
            ...
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                {{ __('Rechazar Solicitud de Matrícula') }}
            </h2>
        </div>

        <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
            {{ __('¿Estás seguro de que deseas rechazar esta solicitud? Esta acción no se puede deshacer.') }}
        </p>

        <form method="POST" id="form-rechazar-solicitud">
            @csrf
            <div class="flex justify-end gap-3">
                <button type="button" @click="$dispatch('close-modal', 'rechazar-solicitud')"
