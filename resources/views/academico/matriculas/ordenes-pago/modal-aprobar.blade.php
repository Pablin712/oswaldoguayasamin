...
<x-modal name="aprobar-orden" maxWidth="md" focusable>
    <div class="p-6">
        <div class="text-center mb-6">
            ...
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                {{ __('Aprobar Orden de Pago') }}
            </h2>
        </div>

        <p class="text-sm text-gray-600 dark:text-gray-400 mb-6" id="aprobar-orden-mensaje">
            {{ __('¿Estás seguro de que deseas aprobar esta orden de pago?') }}
        </p>

        <form method="POST" id="form-aprobar-orden">
            @csrf
            <div class="flex justify-end gap-3">
                <button type="button" @click="$dispatch('close-modal', 'aprobar-orden')"
