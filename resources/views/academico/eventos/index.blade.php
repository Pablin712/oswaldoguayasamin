        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                            ...
                            <p class="mt-1">La interfaz de usuario con calendario FullCalendar está pendiente de desarrollo.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">Módulo: Eventos y Calendario</h3>

                    <div class="space-y-3">
                        <p><strong>Estado del Backend:</strong> ✅ Completado</p>
                        <p><strong>Controlador:</strong> EventoController</p>

                        <div class="mt-6">
                            <h4 class="font-semibold mb-2">Funcionalidades implementadas en el backend:</h4>
                            <ul class="list-disc list-inside space-y-1 text-sm">
                                <li>CRUD completo de eventos</li>
                                <li>Endpoint JSON para FullCalendar</li>
                                <li>Sistema de confirmación de asistencia</li>
                                <li>Eventos públicos y privados por paralelo</li>
                                <li>Tipos de eventos: académico, cultural, deportivo, reunión</li>
                        ...
                        <div class="mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            ...
                            <p class="text-sm">Eventos registrados: {{ isset($eventos) ? $eventos->count() : 0 }}</p>
                            <p class="text-sm">Períodos disponibles: {{ isset($periodos) ? $periodos->count() : 0 }}</p>
                        </div>
                    </div>
                </div>
            </div>
