<x-app-layout>
    @canany(['gestionar horarios', 'ver horarios', 'ver horarios por paralelo'])
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Horario del Paralelo') }}: {{ $paralelo->curso->nombre }} {{ $paralelo->nombre }}
            </h2>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $paralelo->curso->nombre }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Paralelo</p>
                            <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $paralelo->nombre }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Aula</p>
                            <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $paralelo->aula->nombre ?? 'No asignada' }}</p>
                        </div>
                        <div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    @foreach(['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'] as $dia)
                                        <td class="px-3 py-3 text-sm text-gray-900 dark:text-gray-100">
                                            ...
                                            @elseif($clase)
                                                <div class="bg-blue-100 dark:bg-blue-900 border border-blue-300 dark:border-blue-700 rounded-lg p-3">
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center text-sm text-gray-500 dark:text-gray-400">
                                        No hay horarios registrados para este paralelo
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
