        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                            ...
                            <p class="mt-1">La interfaz de usuario con grid de horarios está pendiente de desarrollo.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">Módulo: Gestión de Horarios</h3>

                    <div class="space-y-3">
                        <p><strong>Estado del Backend:</strong> ✅ Completado</p>
                        <p><strong>Controlador:</strong> HorarioController</p>

                        <div class="mt-6">
                            <h4 class="font-semibold mb-2">Funcionalidades implementadas en el backend:</h4>
                            <ul class="list-disc list-inside space-y-1 text-sm">
                                <li>CRUD completo de horarios</li>
                                <li>Detección automática de conflictos de horario</li>
                                <li>Vista de horario por paralelo (grid semanal)</li>
                                <li>Vista de horario por docente</li>
                                <li>Vista de horario por aula</li>
                                <li>Validación de colisiones de tiempo</li>
                            </ul>
                        </div>

                        <div class="mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            <p class="text-sm"><strong>Datos cargados:</strong></p>
                            <p class="text-sm">Horarios registrados: {{ isset($horarios) ? $horarios->total() : 0 }}</p>
                            <p class="text-sm">Paralelos: {{ isset($paralelos) ? $paralelos->count() : 0 }}</p>
                            <p class="text-sm">Docentes: {{ isset($docentes) ? $docentes->count() : 0 }}</p>
                            <p class="text-sm">Aulas: {{ isset($aulas) ? $aulas->count() : 0 }}</p>
                        </div>
                    </div>
                </div>
            </div>
