<x-app-layout>
                ...
                <div class="p-6">
                    <x-enhanced-table
                        ...
                        :headers="[
                            ...
                            ['label' => 'Materias', 'type' => 'number'],
                            ['label' => 'Estado', 'type' => 'string'],
                            ['label' => 'Acciones', 'type' => 'actions'],
                        ]"
                        :csv="auth()->user()->canany(['generar reporte areas', 'gestionar areas'])"
                        :excel="auth()->user()->canany(['generar reporte areas', 'gestionar areas'])"
                        :pdf="auth()->user()->canany(['generar reporte areas', 'gestionar areas'])"
                        :print="auth()->user()->canany(['generar reporte areas', 'gestionar areas'])"
                        :json="auth()->user()->canany(['generar reporte areas', 'gestionar areas'])"
                    >
                        <x-slot name="buttons">
                            @canany(['gestionar areas', 'crear areas'])
                                <button x-data
                                        @click="$dispatch('open-modal', 'create-area')"
    ...
    <!-- Incluir modales -->
    @canany(['gestionar areas', 'crear areas'])
        @include('estructura.areas.create')
    @endcanany
